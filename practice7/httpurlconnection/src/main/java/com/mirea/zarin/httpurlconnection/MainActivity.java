package com.mirea.zarin.httpurlconnection;
...
public class MainActivity extends AppCompatActivity
{
    ...
    private class DownloadPageTask extends AsyncTask<String, Void, String>
    {
        ...
        protected void onPreExecute() {
            ...
            countryView.setText("Загружаем...");
            regionView.setText("Загружаем...");
            cityView.setText("Загружаем...");
            timezoneView.setText("Загружаем...");
        }
        @Override
        ...
        protected void onPostExecute(String result)
        {
            try
            {
                ...
                ipView.setText(responseJson.getString("query"));
                countryView.setText(responseJson.getString("country"));
                regionView.setText(responseJson.getString("regionName"));
                cityView.setText(responseJson.getString("city"));
                timezoneView.setText(responseJson.getString("timezone"));
